...
public class LoginController implements CommunityConstant {
    ...
    public String login(String username, String password, String code, boolean rememberme,
                        Model model,HttpServletResponse response, @CookieValue("captchaOwner") String captchaOwner) {
        // 检查验证码
        String kaptcha = null;
        ...
        Map<String, Object> loginMap = userService.login(username, password, expiredSecond);
        if (loginMap.containsKey("ticket")) {
            Cookie cookie = new Cookie("ticket", (String) loginMap.get("ticket"));
            cookie.setPath(contextPath);
